...
protected:
	...
	CStatic StaticIDS_STRING_ADJUST;
	CComboBox ComboIDS_COMBO_ADJUST;

	CStatic StaticIDS_STRING_FONT_SIZE;
	CStatic StaticIDS_STRING_WIDTH;

	CStatic StaticIDS_STRING_LINE_LENGTH;
	CStatic StaticIDS_STRING_HEIGHT;
