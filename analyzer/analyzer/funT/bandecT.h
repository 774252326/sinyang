...
template <typename T>
void bandec(T **a, unsigned long n, int m1, int m2, T **al,
	unsigned long indx[], T *d)
	//Given an n ¡Á n band diagonal matrix A with m1 subdiagonal rows and m2 superdiagonal rows,
	...
	//pivoting; d is output as ¡À1 depending on whether the number of row interchanges was even
