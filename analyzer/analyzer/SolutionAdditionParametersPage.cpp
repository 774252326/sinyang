// SolutionAdditionParametersPage.cpp : implementation file
//
...
IMPLEMENT_DYNAMIC(SolutionAdditionParametersPage, CPropertyPage)

	SolutionAdditionParametersPage::SolutionAdditionParametersPage()
	: CPropertyPage(SolutionAdditionParametersPage::IDD)
	//, vmsvol(0)
{
...
void SolutionAdditionParametersPage::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(SolutionAdditionParametersPage, CPropertyPage)
	ON_WM_CREATE()
...
// SolutionAdditionParametersPage message handlers


BOOL SolutionAdditionParametersPage::OnSetActive()
{
...
BOOL SolutionAdditionParametersPage::OnInitDialog()
{
...
int SolutionAdditionParametersPage::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
...
void SolutionAdditionParametersPage::BuildList(int width)
{
...
void SolutionAdditionParametersPage::OnItemchangedList(NMHDR* pNMHDR, LRESULT* pResult) 
{
...
BOOL SolutionAdditionParametersPage::OnKillActive()
{
	// TODO: Add your specialized code here and/or call the base class
...
void SolutionAdditionParametersPage::SetList(void)
{
...
void SolutionAdditionParametersPage::GetList(void)
{
	UpdateData(TRUE);
...
//int SolutionAdditionParametersPage::GetChoice(int nItem, int nSubItem)
//{
...
void SolutionAdditionParametersPage::OnShowWindow(BOOL bShow, UINT nStatus)
{
