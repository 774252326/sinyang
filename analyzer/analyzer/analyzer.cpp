...
BEGIN_MESSAGE_MAP(CanalyzerApp, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &CanalyzerApp::OnAppAbout)
...
CanalyzerApp::CanalyzerApp()
{
	...
	SetAppID(_T("analyzer.AppID.NoVersion"));
...
void CanalyzerApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// CanalyzerApp customization load/save methods

void CanalyzerApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CanalyzerApp::LoadCustomState()
{
}

void CanalyzerApp::SaveCustomState()
{
}
